...
partial class MainWindowUnloaded
{
	public sealed partial class Handler : global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.Message.MainWindowUnloaded.Notification, global::System.ValueTuple>
	{
		...
		private readonly global::MainCore.Tasks.Behaviors.LoggingBehavior<global::MainCore.Notification.Message.MainWindowUnloaded.Notification, global::System.ValueTuple> _loggingBehavior;

		public Handler(
			global::MainCore.Notification.Message.MainWindowUnloaded.HandleBehavior handleBehavior,
			global::MainCore.Tasks.Behaviors.LoggingBehavior<global::MainCore.Notification.Message.MainWindowUnloaded.Notification, global::System.ValueTuple> loggingBehavior
		)
		{
