...
partial class QueueRefresh
{
	public sealed partial class Handler : global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.ByAccountVillageIdBase, global::System.ValueTuple>
	{
		...
		public Handler(
			global::MainCore.Notification.Handlers.Refresh.QueueRefresh.HandleBehavior handleBehavior
		)
		{
	...
	public sealed class HandleBehavior : global::Immediate.Handlers.Shared.Behavior<global::MainCore.Notification.ByAccountVillageIdBase, global::System.ValueTuple>
	{
		...
		{
			await global::MainCore.Notification.Handlers.Refresh.QueueRefresh
				.HandleAsync(
					request
					, _viewModel
					, cancellationToken
	...
	)
	{
		...
		services.Add(new(typeof(global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.ByAccountVillageIdBase, global::System.ValueTuple>), typeof(global::MainCore.Notification.Handlers.Refresh.QueueRefresh.Handler), lifetime));
