...
partial class StartAdventureTaskTrigger
{
	public sealed partial class Handler : global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.Base.IAccountNotification, global::System.ValueTuple>
	{
		...
		public Handler(
			global::MainCore.Notification.Handlers.Trigger.StartAdventureTaskTrigger.HandleBehavior handleBehavior
		)
		{
	...
	public sealed class HandleBehavior : global::Immediate.Handlers.Shared.Behavior<global::MainCore.Notification.Base.IAccountNotification, global::System.ValueTuple>
	{
		...
		{
			await global::MainCore.Notification.Handlers.Trigger.StartAdventureTaskTrigger
				.HandleAsync(
					request
					, _taskManager
					, _contextFactory
	...
	)
	{
		...
		services.Add(new(typeof(global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.Base.IAccountNotification, global::System.ValueTuple>), typeof(global::MainCore.Notification.Handlers.Trigger.StartAdventureTaskTrigger.Handler), lifetime));
