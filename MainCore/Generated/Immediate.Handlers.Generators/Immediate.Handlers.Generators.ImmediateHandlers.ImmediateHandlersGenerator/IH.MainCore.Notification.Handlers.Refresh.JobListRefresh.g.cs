...
partial class JobListRefresh
{
	public sealed partial class Handler : global::Immediate.Handlers.Shared.IHandler<global::MainCore.Constraints.IVillageNotification, global::System.ValueTuple>
	{
		...
		public Handler(
			global::MainCore.Notification.Handlers.Refresh.JobListRefresh.HandleBehavior handleBehavior
		)
		{
	...
	public sealed class HandleBehavior : global::Immediate.Handlers.Shared.Behavior<global::MainCore.Constraints.IVillageNotification, global::System.ValueTuple>
	{
		...
		{
			await global::MainCore.Notification.Handlers.Refresh.JobListRefresh
				.HandleAsync(
					request
					, _viewModel
					, cancellationToken
	...
	)
	{
		...
		services.Add(new(typeof(global::Immediate.Handlers.Shared.IHandler<global::MainCore.Constraints.IVillageNotification, global::System.ValueTuple>), typeof(global::MainCore.Notification.Handlers.Refresh.JobListRefresh.Handler), lifetime));
