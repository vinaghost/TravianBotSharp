...
partial class UseragentClean
{
	public sealed partial class Handler : global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.Message.MainWindowUnloaded, global::System.ValueTuple>
	{
		...
		public Handler(
			global::MainCore.Notification.Handlers.MainWindowUnload.UseragentClean.HandleBehavior handleBehavior
		)
		{
	...
	public sealed class HandleBehavior : global::Immediate.Handlers.Shared.Behavior<global::MainCore.Notification.Message.MainWindowUnloaded, global::System.ValueTuple>
	{
		...
		{
			await global::MainCore.Notification.Handlers.MainWindowUnload.UseragentClean
				.HandleAsync(
					request
					, _useragentManager
					, cancellationToken
	...
	)
	{
		...
		services.Add(new(typeof(global::Immediate.Handlers.Shared.IHandler<global::MainCore.Notification.Message.MainWindowUnloaded, global::System.ValueTuple>), typeof(global::MainCore.Notification.Handlers.MainWindowUnload.UseragentClean.Handler), lifetime));
