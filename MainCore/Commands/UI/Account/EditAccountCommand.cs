...
namespace MainCore.Commands.UI.Account
{
    ...
    public class EditAccountCommandHandler : IRequestHandler<EditAccountCommand>
    {
        ...
        public EditAccountCommandHandler(IValidator<AccountInput> accountInputValidator, IDialogService dialogService, WaitingOverlayViewModel waitingOverlayViewModel, IUnitOfRepository unitOfRepository, IMediator mediator)
        {
