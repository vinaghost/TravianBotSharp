...
namespace MainCore.Commands.UI.Farming
{
    ...
    public class StartFarmListCommandHandler : IRequestHandler<StartFarmListCommand>
    {
        ...
        public StartFarmListCommandHandler(ITaskManager taskManager, IDialogService dialogService, IFarmRepository farmRepository)
        {
        ...
        public async Task Handle(StartFarmListCommand request, CancellationToken cancellationToken)
        {
            ...
            var useStartAllButton = new GetSetting().BooleanByName(accountId, Common.Enums.AccountSettingEnums.UseStartAllButton);
