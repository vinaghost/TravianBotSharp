...
namespace MainCore.Commands.UI
{
    ...
    public class DeleteAccountCommand
    {
        ...
        public DeleteAccountCommand(ITaskManager taskManager, IDialogService dialogService, IDbContextFactory<AppDbContext> contextFactory, AccountUpdated.Handler accountUpdated, ITimerManager timerManager)
        {
