...
namespace MainCore.Tasks
{
    ...
    {
        public UpdateBuildingTask(UnitOfCommand unitOfCommand, IUnitOfRepository unitOfRepository, IMediator mediator) : base(unitOfCommand, unitOfRepository, mediator)
        {
        }
