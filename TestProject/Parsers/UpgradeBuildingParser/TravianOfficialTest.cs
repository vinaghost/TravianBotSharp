...
namespace TestProject.Parsers.UpgradeBuildingParser
{
    ...
    public class TravianOfficialTest : ParserTestBase<TravianOfficial>
    {
        ...
        {
            var (parser, html) = Setup("TravianOfficial_construct.html");
        ...
        {
            var (parser, html) = Setup("TravianOfficial_upgrade.html");
        ...
        {
            var (parser, html) = Setup("TravianOfficial_resource.html");
