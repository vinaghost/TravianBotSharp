    ...
    public partial class MainLayoutUc : MainLayoutUcBase
    {
        public MainLayoutUc()
        {
            ...
            this.WhenActivated(d =>
            {
                ...
                this.OneWayBind(ViewModel, vm => vm.AccountTabStore.HeroFarmingViewModel, v => v.HeroFarming.ViewModel).DisposeWith(d);
                ...
                this.OneWayBind(ViewModel, vm => vm.AccountTabStore.IsNormalTabVisible, v => v.HeroFarmingTab.Visibility).DisposeWith(d);
                ...
                this.Bind(ViewModel, vm => vm.AccountTabStore.HeroFarmingViewModel.IsActive, v => v.HeroFarmingTab.IsSelected).DisposeWith(d);
            });
        }
    }
}